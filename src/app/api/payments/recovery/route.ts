    ...
    try {
        ...
        const recoveryTasks = tasks.map(task => {
            ...
            return {
                ...
                received,
                pending,
                latestRemark: task.paymentRemarks[0] ? {
                    ...task.paymentRemarks[0],
                    autoPaymentLink: task.paymentRemarks[0].autoPaymentLink || null,
                    autoReminderStatus: task.paymentRemarks[0].autoReminderStatus || null,
                    autoLinkGeneratedAt: task.paymentRemarks[0].autoLinkGeneratedAt || null,
                } : null,
                allRemarks: task.paymentRemarks.map(r => ({
                    ...r,
                    autoPaymentLink: r.autoPaymentLink || null,
                    autoReminderStatus: r.autoReminderStatus || null,
                    autoLinkGeneratedAt: r.autoLinkGeneratedAt || null,
                })),
