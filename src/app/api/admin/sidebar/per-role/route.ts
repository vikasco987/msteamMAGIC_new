...
export async function GET(req: NextRequest) {
    try {
        ...
        const DEFAULT_PERMISSIONS: Record<string, string[]> = {
            master: ['Dashboard', 'Team Board', 'Create Task', 'Assigned Task', 'Recovery Hub', 'KAM Strategy', 'Sales Matrix', 'Team Sales', 'My Growth', 'CRM Forms', 'Lead Terminal', 'Follow-up Board', 'Call Report', 'Financial Ecosystem', 'Payment Portal Magic Scale', 'Onboard Magic Scale', 'Profit & Loss', 'Attendance', 'Tish Control', 'Activity Log', 'Daily Payments', 'Lifecycle Report', 'Customers', 'Agreements', 'Setup Agreement', 'Timeline', 'Business Setup', 'DB Backups'],
            admin: ['Dashboard', 'Team Board', 'Create Task', 'Assigned Task', 'Recovery Hub', 'KAM Strategy', 'Team Sales', 'My Growth', 'CRM Forms', 'Lead Terminal', 'Follow-up Board', 'Call Report', 'Financial Ecosystem', 'Payment Portal Magic Scale', 'Onboard Magic Scale', 'Attendance', 'Tish Control', 'Activity Log', 'Daily Payments', 'Lifecycle Report', 'Customers', 'Agreements', 'Setup Agreement', 'Timeline', 'Business Setup'],
            tl: ['Dashboard', 'Team Board', 'Create Task', 'Assigned Task', 'Recovery Hub', 'KAM Strategy', 'Team Sales', 'My Growth', 'CRM Forms', 'Lead Terminal', 'Follow-up Board', 'Call Report', 'Financial Ecosystem', 'Payment Portal Magic Scale', 'Onboard Magic Scale', 'Attendance', 'Tish Control', 'Activity Log', 'Daily Payments', 'Lifecycle Report', 'Customers', 'Agreements', 'Setup Agreement', 'Timeline'],
            seller: ['Dashboard', 'Team Board', 'Create Task', 'Assigned Task', 'Recovery Hub', 'KAM Strategy', 'My Growth', 'CRM Forms', 'Payment Portal Magic Scale', 'Onboard Magic Scale', 'Follow-up Board', 'Call Report', 'Attendance', 'Activity Log', 'Customers', 'Agreements', 'Setup Agreement', 'Timeline'],
