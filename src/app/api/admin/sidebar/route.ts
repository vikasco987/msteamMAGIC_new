...
export async function GET(req: NextRequest) {
    try {
        ...
        const allItems = [
            ...
            'Agreements', 'Setup Agreement', 'Timeline', 'Client Locator', 'Access Control', 'Employee Directory', 'Team Management', 'Payroll Management', 'DB Backups', 'POS Sign-ups'
        ];

        const DEFAULT_PERMISSIONS: Record<string, string[]> = {
            master: ['Dashboard', 'Team Board', 'Create Task', 'Assigned Task', 'Recovery Hub', 'KAM Strategy', 'Sales Matrix', 'Team Sales', 'My Growth', 'CRM Forms', 'Follow-up Board', 'Call Report', 'Financial Ecosystem', 'Payment Portal', 'Payment Analytics', 'Attendance', 'Tish Control', 'Activity Log', 'Lifecycle Report', 'Customers', 'Payroll Management', 'Agreements', 'Setup Agreement', 'Timeline', 'Client Locator', 'Employee Directory', 'DB Backups', 'POS Sign-ups'],
