...
const API_BASE_URL = "/api/razorpay";
              ...
              <div className="flex items-center gap-3">
                ...
                {hasAnalyticsAccess && (
                  <>
                    ...
                    <Link 
                      href="/payment-portal-2/analytics"
          ...
          >
            ...
            {fetchingHistory ? (
              <div className="py-40 flex flex-col items-center gap-6">
                ...
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] animate-pulse">Syncing with Razorpay Node</p>
              </div>
            ) : (
